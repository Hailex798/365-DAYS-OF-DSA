...
<ul>
	...
	<li><code>'*'</code> could be treated as a single right parenthesis <code>')'</code> or a single left parenthesis <code>'('</code> or an <span class="wiseone-analysis-result wiseone-analysis-result-entity">empty string</span> <code>""</code>.</li>
</ul>
