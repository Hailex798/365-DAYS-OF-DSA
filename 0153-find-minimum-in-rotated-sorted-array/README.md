...
<p><span class="wiseone-analysis-result wiseone-analysis-result-fact">You must write an algorithm that runs in&nbsp;<code><span class="wiseone-analysis-result wiseone-analysis-result-entity">O(log n)</span> time.</code></span></p>
