...
<ul>
	...
	<li><code>board</code> and <code>word</code> consists of only lowercase and <span class="wiseone-analysis-result wiseone-analysis-result-entity">uppercase</span> English letters.</li>
</ul>
