<h2><a href="https://leetcode.com/problems/score-after-flipping-matrix/">861. Score After Flipping Matrix</a></h2><h3>Medium</h3><hr><div><p>You are given an <code>m x n</code> <span class="wiseone-analysis-result wiseone-analysis-result-entity">binary matrix</span> <code>grid</code>.</p>
...
<p>Every row of the matrix is interpreted as a <span class="wiseone-analysis-result wiseone-analysis-result-entity">binary number</span>, and the <strong>score</strong> of the matrix is the sum of these numbers.</p>
