...
<ul>
	...
	<li><code>dictionary[i]</code> consists of only <span class="wiseone-analysis-result wiseone-analysis-result-entity">lower-case letters</span>.</li>
	<li><code>1 &lt;= sentence.length &lt;= 10<sup>6</sup></code></li>
	<li><code>sentence</code> consists of only <span class="wiseone-analysis-result wiseone-analysis-result-entity wiseone-analysis-result-repeat">lower-case letters</span> and spaces.</li>
