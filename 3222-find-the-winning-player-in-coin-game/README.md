<h2><a href="https://leetcode.com/problems/find-the-winning-player-in-coin-game/">3222. Find the Winning Player in Coin Game</a></h2><h3>Easy</h3><hr><div><p>You are given two <span class="wiseone-analysis-result wiseone-analysis-result-entity"><strong>positive</strong> integers</span> <code>x</code> and <code>y</code>, denoting the number of coins with values 75 and 10 <em>respectively</em>.</p>

<p><span class="wiseone-analysis-result wiseone-analysis-result-entity">Alice and Bob</span> are playing a game. Each turn, starting with <strong>Alice</strong>, the player must pick up coins with a <strong>total</strong> value 115. If the player is unable to do so, they <strong>lose</strong> the game.</p>
