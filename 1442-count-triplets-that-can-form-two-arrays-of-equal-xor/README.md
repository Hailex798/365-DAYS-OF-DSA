...
<p><span class="wiseone-analysis-result wiseone-analysis-result-fact">Note that <strong>^</strong> denotes the <strong><span class="wiseone-analysis-result wiseone-analysis-result-entity">bitwise-xor</span></strong> operation.</span></p>
