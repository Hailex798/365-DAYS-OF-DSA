...
<p>A <span class="wiseone-analysis-result wiseone-analysis-result-entity"><strong>prefix</strong> of a string</span> <code>s</code> is any leading contiguous <span class="wiseone-analysis-result wiseone-analysis-result-entity">substring</span> of <code>s</code>.</p>
