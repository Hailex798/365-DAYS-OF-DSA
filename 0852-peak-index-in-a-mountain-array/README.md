...
<p><span class="wiseone-analysis-result wiseone-analysis-result-fact">You must solve it in <code>O(log(arr.length))</code> <span class="wiseone-analysis-result wiseone-analysis-result-entity">time complexity</span>.</span></p>
