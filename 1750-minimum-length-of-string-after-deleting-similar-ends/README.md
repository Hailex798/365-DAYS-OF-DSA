...
<ol>
	<li>Pick a <strong><span class="wiseone-analysis-result wiseone-analysis-result-entity">non-empty</span></strong> prefix from the string <code>s</code> where all the characters in the prefix are equal.</li>
	<li>Pick a <strong><span class="wiseone-analysis-result wiseone-analysis-result-entity wiseone-analysis-result-repeat">non-empty</span></strong> suffix from the string <code>s</code> where all the characters in this suffix are equal.</li>
