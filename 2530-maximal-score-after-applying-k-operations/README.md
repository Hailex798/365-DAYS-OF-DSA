...
<p>The <span class="wiseone-analysis-result wiseone-analysis-result-entity">ceiling function</span> <code>ceil(val)</code> is the least integer <span class="wiseone-analysis-result wiseone-analysis-result-entity">greater than or equal to</span> <code>val</code>.</p>
