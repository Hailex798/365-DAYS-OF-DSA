...
<p>A <strong>fixed-bound <span class="wiseone-analysis-result wiseone-analysis-result-entity">subarray</span></strong> of <code>nums</code> is a subarray that satisfies the following conditions:</p>
