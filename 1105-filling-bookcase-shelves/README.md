...
<p>We want to place these books in order onto <span class="wiseone-analysis-result wiseone-analysis-result-entity">bookcase</span> shelves that have a total width <code>shelfWidth</code>.</p>

<p>We choose some of the books to place on this shelf such that the sum of their thickness is less than or equal to <code>shelfWidth</code>, then build another level of the shelf of the <span class="wiseone-analysis-result wiseone-analysis-result-entity">bookcase</span> so that the total height of the <span class="wiseone-analysis-result wiseone-analysis-result-entity">bookcase</span> has increased by the maximum height of the books we just put down. We repeat this process until there are no more books to place.</p>
