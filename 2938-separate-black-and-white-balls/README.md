...
<p>You are given a <strong>0-indexed</strong> <span class="wiseone-analysis-result wiseone-analysis-result-entity">binary string</span> <code>s</code> of length <code>n</code>, where <code>1</code> and <code>0</code> represent black and white balls, respectively.</p>
