...
<strong>Explanation:</strong> All ants are going to the right, the ant at index 0 needs <span class="wiseone-analysis-result wiseone-analysis-result-entity">7 seconds</span> to fall.
</pre>
...
<strong>Output:</strong> 7
<strong>Explanation:</strong> All ants are going to the left, the ant at index 7 needs <span class="wiseone-analysis-result wiseone-analysis-result-entity wiseone-analysis-result-repeat">7 seconds</span> to fall.
</pre>
