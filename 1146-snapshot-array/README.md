...
<ul>
	<li><code>SnapshotArray(int length)</code> initializes an array-like <span class="wiseone-analysis-result wiseone-analysis-result-entity">data structure</span> with the given length. <strong>Initially, each element equals 0</strong>.</li>
